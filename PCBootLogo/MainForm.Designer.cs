...
namespace PCBootLogo
{
    partial class MainForm
    {
      ...
      // cbxStretch
      // 
      this.cbxStretch.AutoSize = true;
      this.cbxStretch.Enabled = false;
      this.cbxStretch.Location = new System.Drawing.Point(371, 49);
      this.cbxStretch.Margin = new System.Windows.Forms.Padding(2);
      this.cbxStretch.Name = "cbxStretch";
      this.cbxStretch.Size = new System.Drawing.Size(134, 24);
      this.cbxStretch.TabIndex = 6;
      this.cbxStretch.Text = "Stretch image";
      this.cbxStretch.UseVisualStyleBackColor = true;
      // 
      // MainForm
      // 
